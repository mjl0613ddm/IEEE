...
def save_model_seed_data(base_path, model_name, seed_name):
    ...
    data_output_dir = os.path.join(base_path, 'datas', model_name, seed_name, 'data')
...
def main():
    """主函数."""
    parser = argparse.ArgumentParser(description='Save plot data script for ACL24-EconAgent')
