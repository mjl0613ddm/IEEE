...
# 数据路径（相对于项目根目录）
REAL_ACTIONS_JSON="data/gpt-4o-verify/actions_json/all_actions.json"
...
# 随机种子（用于多次运行取平均）
SEEDS=(42 43 401 45 46 613 48 49 50 51)  # 10个种子

# MC采样次数列表（用于测试不同采样次数的误差）
MC_SAMPLES_LIST=(10 100 1000 10000)

# 输出目录
OUTPUT_DIR="results/gpt_shapley_error_analysis"
